...
describe("StableSwapTwoPool Contract Tests with ROSE", function () {
    ...
    const GasPriceDefault = BigNumber.from(10000000000); 
    ...
    it("should add liquidity with ROSE", async function () {
        ...
        if (ROSE_index == 0) {
          ...
          let tx = await swap_ROSE_WROSE.add_liquidity([1e6, 1e6], expect_LP_balance, {value: 1e6});
          await tx.wait();
    ...
    //     if (ROSE_index == 0) {
    //       let tx = await swap_ROSE_WROSE.add_liquidity([defaultToken0Amount, 0], expect_LP_balance0, {value: 1e3});
    //       await tx.wait();
    //     } else {
    //       let tx = await swap_ROSE_WROSE.add_liquidity([defaultToken0Amount, 0], expect_LP_balance0, {value: 0});
    //       await tx.wait();
    //     }
    ...
    //   let tx = await swap_ROSE_WROSE.remove_liquidity(remove_LP_balance, [0, 0]);
    //   const receipt = await tx.wait();
    //   let gasUsed = BigNumber.from(receipt.cumulativeGasUsed).mul(GasPriceDefault);
    ...
    //   console.log("ROSE_balance_before: ", ROSE_balance_before);
    //   console.log("ROSE_balance_after: ", ROSE_balance_after);
    //   console.log("expectCoins[1]: ", expectCoins[1]);
    ...
    //     let tx = await swap_ROSE_WROSE.remove_liquidity_imbalance(remove_token_amounts, max_burnamount);
    //     const receipt = await tx.wait();
    //     let gasUsed = BigNumber.from(receipt.cumulativeGasUsed).mul(GasPriceDefault);
    ...
    //     // defaultTokenAmount = user_ROSE_balance_after - user_ROSE_balance_before + gasUsed
    //     console.log("user_ROSE_balance_before: ", user_ROSE_balance_before);
    //     console.log("user_ROSE_balance_after: ", user_ROSE_balance_after);
    //     console.log("gasUsed: ", gasUsed);
    ...
    //     let tx;
    //     if (ROSE_index == 0) {
    //         tx = await swap_ROSE_WROSE.remove_liquidity_one_coin(defaultTokenAmount, 0, expect_Token1_amount);
    //     } else {
    //         tx = await swap_ROSE_WROSE.remove_liquidity_one_coin(defaultTokenAmount, 1, expect_Token1_amount);
    //     }
    //     const receipt = await tx.wait();
    //     let gasUsed = BigNumber.from(receipt.cumulativeGasUsed).mul(GasPriceDefault);
    ...
    //     let tx;
    //     if (ROSE_index == 0) {
    //       tx = await swap_ROSE_WROSE.exchange(1, 0, exchange_wROSE_balance, expect_ROSE_balance);
    //     } else {
    //       tx = await swap_ROSE_WROSE.exchange(0, 1, exchange_wROSE_balance, expect_ROSE_balance);
    //     }
    //     const receipt = await tx.wait();
    //     let gasUsed = BigNumber.from(receipt.cumulativeGasUsed).mul(GasPriceDefault);
    ...
    //     console.log("user_ROSE_balance_after: ", user_ROSE_balance_after);
    //     console.log("gasUsed: ", gasUsed);
    //     console.log("expect_ROSE_balance: ", expect_ROSE_balance);
    //     // check ROSE balance: user_ROSE_balance_after - user_ROSE_balance_before + gasUsed 
    //     //= swap_ROSE_balance_before - swap_ROSE_balance_after - exchangeFees[1]
    //     //= swapContract_ROSE_balance_before - swapContract_ROSE_balance_after
    //     console.log(BigNumber.from(swap_ROSE_balance_before).sub(swap_ROSE_balance_after).sub(exchangeFees[1]));
    //     console.log(swapContract_ROSE_balance_before.sub(swapContract_ROSE_balance_after));
    //   });
    ...
    //     let tx;
    //     if (ROSE_index == 0) {
    //       tx = await swap_ROSE_WROSE.exchange(0, 1, exchange_ROSE_balance, expect_wROSE_balance, {value: exchange_ROSE_balance});
    //     } else {
    //       tx = await swap_ROSE_WROSE.exchange(1, 0, exchange_ROSE_balance, expect_wROSE_balance, {value: exchange_ROSE_balance});
    //     }
    //     const receipt = await tx.wait();
    //     let gasUsed = BigNumber.from(receipt.cumulativeGasUsed).mul(GasPriceDefault);
    ...
    //     user_wROSE_balance_after = await WROSE.balanceOf(user1);
    //     user_ROSE_balance_after = await waffle.provider.getBalance(user1!);
    //     //check user ROSE balance: exchange_ROSE_balance = user_ROSE_balance_before - user_ROSE_balance_after + gasUsed
    //     console.log("user_ROSE_balance_before: ", user_ROSE_balance_before);
    //     console.log("user_ROSE_balance_after: ", user_ROSE_balance_after);
    //     console.log("gasUsed: ", gasUsed);
    //     console.log("expect_ROSE_balance: ", exchange_ROSE_balance);
    //     //check exchange admmin fee
    ...
    //     );
    //     //user_ROSE_balance_after - user_ROSE_balance_before + gasUsed = swapContract_ROSE_balance_before - swapContract_ROSE_balance_after
    //     console.log(swapContract_ROSE_balance_before.sub(swapContract_ROSE_balance_after));
    //   });
});